...
public class AboutSwipeActivity extends AppCompatActivity {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_about_swipe, menu);
        return true;
    }
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            switch(getArguments().getInt(ARG_SECTION_NUMBER)){
                case 1:
                    ...
                    break;
                case 2:
                    rootView = inflater.inflate(R.layout.activity_about2, container, false);
                    break;
                case 3:
                    rootView = inflater.inflate(R.layout.activity_about3, container, false);
                    break;
                case 4:
    ...
    public static Intent makeIntent(Context context){
        Intent intent = new Intent(context, AboutSwipeActivity.class);
        return intent;
    }
}
